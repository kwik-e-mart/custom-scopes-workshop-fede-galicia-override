# Api Manager (service nullplatform)
...
variable de entorno `API_MANAGER_API_KEY`, inyectada como secret parameter — nunca en texto plano en
ningún lado que un humano tenga que copiar. Ese `API_MANAGER_API_KEY` va en el header `x-api-key` de
