...
| 10 | Los cinco códigos — **verificados end-to-end contra EKS real** |
...
## Paso 5 — `build_context` contra un scope real y alcanzable
...
## Paso 10 — Los cinco códigos, verificados end-to-end contra EKS real
