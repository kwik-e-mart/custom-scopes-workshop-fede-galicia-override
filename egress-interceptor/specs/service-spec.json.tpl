{
  ...
  "attributes": {
    "schema": {
      ...
      "required": ["cluster", "interceptions"],
      "properties": {
        "cluster": {
          "type": "string",
          "title": "Cluster",
          "description": "Cluster sobre el que se aplica esta configuración. Es un campo transitorio: desaparece cuando el cluster pase a ser una dimensión de nullplatform.",
          "order": 1,
          "editableOn": ["create"]
        },
        "interceptions": {
